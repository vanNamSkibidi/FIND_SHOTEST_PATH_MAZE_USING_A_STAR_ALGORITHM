...
public class MonkeyDemon extends Entity {
    ...
    public void getImage() {
        try {
            up1 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/left1.png"));
            up2 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/left2.png"));
            down1 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/down1.png"));
            down2 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/down2.png"));
            left1 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/left1.png"));
            left2 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/left2.png"));
            right1 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/right1.png"));
            right2 = ImageIO.read(new File("F:/2_2024/DSA/Gr15-master/Gr15-master/src/res/monster/right2.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
